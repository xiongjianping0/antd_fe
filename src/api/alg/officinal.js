...
export function addMedicineApi(data) {
  return request({
    url: `${baseUrl}/patentMedicine/create`,
    method: 'post',
    data,
      headers: {
...
export function updataMedicineApi(data) {
  return request({
    url: `${baseUrl}/patentMedicine/update`,
    method: 'put',
    data,
     headers: {
      "Content-Type": "application/json;charset=UTF-8"
...
export function getMedicineDetailApi(data) {
  return request({
    url: `${baseUrl}/patentMedicine/findOne`,
    method: 'get',
    data
  })
}
...
export function getMedicineListApi(data) {
  return request({
    url: `${baseUrl}/patentMedicine/search/page`,
    method: 'post',
    data
  })
}
...
export function deleteOneApi(data) {
  return request({
    url: `${baseUrl}/patentMedicine/delete`,
    method: 'delete',
    data
  })
}
